...
var projection = d3.geo.mercator().center([40,35]) .scale(300) .rotate([0,0,0]); 
    ...
    g.selectAll("path") 
        ...
        .on("click", function(d) { 
            ...
            $.ajax({
                ...
                url: "https://recipesdatabasesimilairites.sb02.stations.graphenedb.com:24789/db/data/transaction/commit",
